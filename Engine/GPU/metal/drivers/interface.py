...
class Interface:
    def __init__(self) -> None:
        ...
        assert os.path.isfile(_objPath + "/lib/libmetalgpucpp-arm.dylib"), "[MOrcaLL] Library not found, please run `python -m metalgpu build`"
    ...
    def create_buffer(self, bufsize: int, buffer_type: str | allowedNumpyTypes | allowedCTypes) -> "Buffer":
        assert bufsize > 0, "[MOrcaLL] Buffer size must be greater than 0"
