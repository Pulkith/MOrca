...
class Buffer:
    ...
    def __add__(self, other : "Buffer") -> "Buffer":
        assert(len(self.contents) == len(other.contents)), "[MOrcaLL] Buffers must be of the same content size"
        assert(self.contents.dtype == other.contents.dtype), "[MOrcaLL] Buffers must be of the same data type"
